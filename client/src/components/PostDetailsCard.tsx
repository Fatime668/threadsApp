...
const PostDetailsCard = ({
  ...
  return (
    <View
      ...
      style={{backgroundColor:"#0d0d0d",flex:1,left: isReply ? 20 : 0, width: isReply ? '95%' : '100%'}}>
      <View className="relative">
        <View className="flex-row w-full justify-between">
          <View className="flex-row items-center">
            ...
            <View className="pl-3">
              ...
              <Text className="text-white mt-1 font-[500] text-[13px]">
                {item.title}
              </Text>
            </View>
          </View>
        ...
        {item.image ? (
          <View className="absolute top-14 left-5 h-[90%] w-[1px] bg-[#424242]" />
        ) : (
          <View className="absolute top-14 left-5 h-[40%] w-[1px] bg-[#424242]" />
        )}
          ...
          {item.reply.length !== 0 && (
            <>
              <View className="flex-row items-center">
                ...
                <TouchableOpacity>
                  <Text className="ml-[10px] mt-[20px] text-[16px]" style={{color:"#fff"}}>
                    {item.likes.length}{' '}
